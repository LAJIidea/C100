...
namespace C100
{
    ...
    SymbolTable::AddVariable(std::string_view id, std::shared_ptr<Type> ty, SourceLocation loc) {
    ...
    std::shared_ptr<Symbol>
    SymbolTable::AddFunction(std::string_view id, std::shared_ptr<Type> ty, SourceLocation loc) {
